.data                               // Put all data within .data block
    numbers:                        // "Name" of array
        .word 1, 2, 3, 4, 5, 6, 7, 0         // Declare the array with bytesize(word in this case which is 32 bytes per character)
...
.global add_array
    ...
    start:
        LDR R1, =numbers            // Upon start, jump here and load the memory adress of numbers into register 1
